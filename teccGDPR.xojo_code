...
Inherits WebSDKControl
	...
	#tag Event
		Sub Serialize(js as JSONItem)
		  ...
		  js.value("cookiePolicyButtonText") = "Button Text" 
		  js.value("cookiePolicyButtonUrl") = "ButtonUrl"
	...
	#tag Event
		Function SessionHead(session as WebSession) As String
		  ...
		  Return "<style id ='teccGDPRinject'></style>"
		End Function
	#tag EndEvent
	...
	#tag Event
		Function SessionJavascriptURLs(session as WebSession) As String()
		  ...
		  If JSFramework = Nil Then
		    ...
		    JSFramework.Filename = "teccGDPR.js"
